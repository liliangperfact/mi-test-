          ...
          <div class="type-wrap logo">
            ...
            <div class="value logos">
              <ul class="logo-list">
                ...
                <li>风行电视</li>
                <li>
                  <img src="./images/search/phone06.png" />
                </li>
                <li>
                  <img src="./images/search/phone07.png" />
                </li>
                <li>
                  <img src="./images/search/phone08.png" />
                </li>
                <li>
                  <img src="./images/search/phone09.png" />
                </li>
                <li>
                  <img src="./images/search/phone10.png" />
                </li>
                <li>
                  <img src="./images/search/phone11.png" />
                </li>
                <li>
                  <img src="./images/search/phone12.png" />
                </li>
                <li>
                  <img src="./images/search/phone12.png" />
                </li>
                <li>
                  <img src="./images/search/phone14.png" />
                </li>
                <li>
                  <img src="./images/search/phone01.png" />
                </li>
                <li>
                  <img src="./images/search/phone06.png" />
                </li>
                ...
                <li>
                  <img src="./images/search/phone02.png" />
                </li>
              </ul>
            </div>
            <div class="ext">
    ...
    /*
        ...
        */
        window.addEventListener("DOMContentLoaded", function () {
            //保存当前缩略图的下标
            let magnifierImgID = 0;// eslint-disable-line no-unused-vars
            //当前的商品数量
            let goodsChangeNum = 1;// eslint-disable-line no-unused-vars
